...
public class Paddle : MonoBehaviour {
	...
	void Update () {
        ...
        float paddlePosInUnits = (Input.mousePosition.x / Screen.width * 16) - 8;
         ...
         * Sinc there is still an offset difference between the mouse and the paddle
         * The offset was noticed to be on the negative side and that is why we need to reduce
         * -8 game units.
         */

        Vector3 newPaddlePos = new Vector3(paddlePosInUnits, gameObject.transform.position.y, gameObject.transform.position.z);
